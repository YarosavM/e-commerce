...
function aletheme_get_options() {
    ...
    $options[] = array( "name" => "Select the body Font from Google Library",
                        "desc" => "The default Font is - Sniglet",
                        "id" => "ale_main_font",
                        "std" => "Sniglet",
                        "type" => "text",
                        "options" => $headerfont);
    ...
    $options[] = array( "name" => "Select additional Font from Google Library",
                        "desc" => "The default Font is - Audiowide",
                        "id" => "ale_additional_font",
                        "std" => "Audiowide",
                        "type" => "text",
                        "options" => $headerfont);

    $options[] = array( "name" => "Select special links Font from Google Library",
                        "desc" => "The default Font is - Yellowtail",
                        "id" => "ale_special_links_font",
                        "std" => "Yellowtail",
                        "type" => "text",
                        "options" => $headerfont);

    $options[] = array( "name" => "Select decored Font-1 for Google Library",
                        "desc" => "Decored Font is - Mountains of Christmas",
                        "id" => "ale_decored_font1",
                        "std" => "Mountains+of+Christmas",
                        "type" => "text",
                        "options" => $headerfont);

    $options[] = array( "name" => "Select decored Font-2 from Google Library",
                        "desc" => "The default Font is - Righteous",
                        "id" => "ale_decored_font2",
                        "std" => "Righteous",
                        "type" => "text",
                        "options" => $headerfont);
    ...
    $options[] = array( 'name' => "H1 Style",
                        ...
                        'id' => 'ale_h1sty',
                        'std' => array('size' => '22px','face' => 'Sniglet','style' => 'normal','color' => '#252525'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H2 Style",
                        'desc' => "Change the h2 style",
                        'id' => 'ale_h2sty',
                        'std' => array('size' => '20px','face' => 'Sniglet','style' => 'normal','color' => '#252525'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H3 Style",
                        'desc' => "Change the h3 style",
                        'id' => 'ale_h3sty',
                        'std' => array('size' => '18px','face' => 'Sniglet','style' => 'normal','color' => '#252525'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H4 Style",
                        'desc' => "Change the h4 style",
                        'id' => 'ale_h4sty',
                        'std' => array('size' => '16px','face' => 'Sniglet','style' => 'normal','color' => '#252525'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H5 Style",
                        'desc' => "Change the h5 style",
                        'id' => 'ale_h5sty',
                        'std' => array('size' => '14px','face' => 'Sniglet','style' => 'normal','color' => '#252525'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H6 Style",
                        'desc' => "Change the h6 style",
                        'id' => 'ale_h6sty',
                        'std' => array('size' => '12px','face' => 'Sniglet','style' => 'normal','color' => '#252525'),
                        'type' => 'typography');

    $options[] = array( 'name' => "Body Style",
                        'desc' => "Change the body font style",
                        'id' => 'ale_bodystyle',
                        'std' => array('size' => '15px','face' => 'Sniglet','style' => 'normal','color' => '#333333'),
                        'type' => 'typography');
